...
- (void)viewDidLoad {
    ...
    UILabel *headerLabel =
	[[[UILabel alloc]
	  initWithFrame:CGRectMake(13, 10, 300, 40)]
	 autorelease];
	...
	[[[UILabel alloc]
	  initWithFrame:CGRectMake(192, 8, 300, 20)]
	 autorelease];
    headerLabel2.text = [NSString stringWithFormat:@"%.0f%%", (float)(100-(dCharge/[arrTrips count]))];
    headerLabel2.textColor = [UIColor darkGrayColor];
    headerLabel2.font = [UIFont fontWithName:@"HelveticaNeue-Bold" size:18.0];
    headerLabel2.backgroundColor = [UIColor clearColor];
	//[containerView addSubview:headerLabel2];
	
	UILabel *headerLabel3 =
	[[[UILabel alloc]
	  initWithFrame:CGRectMake(13, 30, 300, 20)]
	 autorelease];
    headerLabel3.text = @"of your EV battery.";
    headerLabel3.textColor = [UIColor darkGrayColor];
    headerLabel3.font = [UIFont fontWithName:@"HelveticaNeue-Bold" size:12.0];
...
/*- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section 
{
    ...
    UILabel *headerLabel =
	[[[UILabel alloc]
	  initWithFrame:CGRectMake(3, 10, 300, 40)]
	 autorelease];
    headerLabel.text = [[[fetchedResultsController sections] objectAtIndex:section] name];
    headerLabel.textColor = [UIColor darkGrayColor];
